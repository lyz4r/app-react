...
function Home() {
  ...
  return (
    <>
        ...
        <div className="header__top">
          <div className="container">
            <div className="header__top-row">
              ...
              <a className="btn top-row__nav-list-contact" href="./contacts">
                Contact Us
              </a>
      ...
      <main className="main">
        <div>
          Переход на страницу с информацией по кнопке About Us в шапке, а
          страницу с контактами Contacts + реализован компонент 404
        </div>
